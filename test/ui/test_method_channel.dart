...
void setUpTestMethodChannel(String methodChannel, [MethodCodec codec = const StandardMethodCodec()]) {
...
class MethodCallStubbing {
  ...
  bool matches(MethodCall methodCall) {
    return nameMatcher.matches(methodCall.method, null) && argMatcher.matches(methodCall.arguments, null);
  }
}
...
void expectMethodCall(String name, {@required dynamic args}) {
  ...
  expect(
    methodCall,
    isMethodCall(name, arguments: args),
  );
}
