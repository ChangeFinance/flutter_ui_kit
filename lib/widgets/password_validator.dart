...
class PasswordValidator extends StatefulWidget {
  ...
  const PasswordValidator({
    ...
    this.hintList = const ['Try making it longer then 8 digits and adding capital characters that makes it difficult for others to guess',
    ...
    this.colorList = const [Colors.redAccent, Colors.orangeAccent, Colors.blueAccent, Colors.lightGreen, Colors.greenAccent],
...
class _PasswordValidatorState extends State<PasswordValidator> {
  ...
  Widget build(BuildContext context) {
    ...
    int _passwordStrength() {
      ...
      if(widget.password.contains(new RegExp(r'[!@_#$\%;^&*+(),.?":\-{}|<>/\\]'))){
        counter = counter + 1;
      }
      return counter;
    }
    ...
    String _strengthToText() {
      ...
      switch(passwordStrength) {
        case 1: { return 'Strength: ${widget.strengthList[0]}'; }
        break;

        case 2: { return 'Strength: ${widget.strengthList[1]}'; }
        break;

        case 3: { return 'Strength: ${widget.strengthList[2]}'; }
        break;

        case 4: { return 'Strength: ${widget.strengthList[3]}'; }
        break;

        case 5: { return 'Strength: ${widget.strengthList[4]}'; }
        break; 

        default: { return 'Strength: ${widget.strengthList[0]}'; }
      }
    }
    ...
    Color _strengthToColor() {
      final passwordStrength = _passwordStrength();
      switch(passwordStrength) {
        case 1: { return widget.colorList[0]; }
        break;

        case 2: { return widget.colorList[1]; }
        break;

        case 3: { return widget.colorList[2]; }
        break;

        case 4: { return widget.colorList[3]; }
        break;

        case 5: { return widget.colorList[4]; }
        break;

        default: { return widget.colorList[0]; }
      }
    }
